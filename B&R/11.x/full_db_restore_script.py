...
# scp -i ~/.ssh/your_key.pem /path/to/DataRobot/tools/full_db_restore_script.py \
...
# Usage Example:
#          python full_db_restore_script.py my-test-namespace /absolute-datarobot-backup-location postgres  # for PostgreSQL only restore
#          python full_db_restore_script.py my-test-namespace /absolute-datarobot-backup-location mongodb     # for MongoDB only restore
#          python full_db_restore_script.py my-test-namespace /absolute-datarobot-backup-location complete     # for both PostgreSQL and MongoDB databases restore
